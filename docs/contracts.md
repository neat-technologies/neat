...
| 11 | `getBlastRadius` | [`contracts/get-blast-radius.md`](./contracts/get-blast-radius.md) | BFS inbound (the origin's dependents) default depth 10, distance positive, per-node path + cascaded confidence, schema-validated (supersedes ADR-038's outbound direction) | ✅ landed (v0.2.3 opens) |
