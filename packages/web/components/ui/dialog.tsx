...
// Copy-own; no cross-repo dependency. Trimmed: the close-button affordance is
// left to callers (the command palette closes on Escape / selection), so this
// file doesn't pull in Button/XIcon.
'use client'
